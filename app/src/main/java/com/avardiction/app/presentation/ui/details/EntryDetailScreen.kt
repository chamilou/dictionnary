package com.avardiction.app.presentation.ui.details
...
fun EntryDetailScreen(
    ...
    val primaryTexts = buildSet {
        entry.avarText?.let { add(it.normalizedForDetailComparison()) }
        targetTranslation?.text?.let { add(it.normalizedForDetailComparison()) }
        russianTranslation?.text?.let { add(it.normalizedForDetailComparison()) }
    }
...
private fun String.normalizedForDetailComparison(): String {
